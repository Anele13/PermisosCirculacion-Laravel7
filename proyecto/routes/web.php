...
Route::get('/autorizar_permiso/{token}','PermisosController@mostrar_permiso')->name('autorizar_permiso');
Route::post('/autorizar/{token}', 'PermisosController@autorizar')->name('autorizar');
